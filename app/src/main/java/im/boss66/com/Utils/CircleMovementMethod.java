...
public class CircleMovementMethod extends BaseMovementMethod {
    ...
    public CircleMovementMethod(){
        ...
        this.textViewBgColor = mApplication.getResources().getColor(DEFAULT_COLOR_ID);
        this.clickableSpanBgClor = mApplication.getResources().getColor(DEFAULT_CLICKABLEA_COLOR_ID);
    }
    ...
    public CircleMovementMethod(int clickableSpanBgClor){
        ...
        this.textViewBgColor = App.getInstance().getResources().getColor(DEFAULT_COLOR_ID);
    }
