...
public class ImageObject {
    ...
    public void drawIcon(Canvas canvas) {
        ...
        PointF point_left_top = getPointLeftTop();
        PointF point_left_bot = getPointLeftBottom();
        PointF point_right_top = getPointRightTop();
        PointF point_right_bot = getPointRightBottom();

        float width1 = deleteBm.getWidth() / 2;
        float height1 = deleteBm.getHeight() / 2;


        Log.i("info", "width1:" + width1 + "height1:" + height1);
        float width2 = rotateBm.getWidth() / 2;
        float height2 = rotateBm.getHeight() / 2;

        float x1 = point_left_top.x;
        float y1 = point_left_top.y;

        float x2 = point_left_bot.x;
        float y2 = point_left_bot.y;

        float x3 = point_right_top.x;
        float y3 = point_right_top.y;

        float x4 = point_right_bot.x;
        float y4 = point_right_bot.y;
        ...
        canvas.drawLine(x1, y1, x3, y3, paint1);
        canvas.drawLine(x4, y4, x3, y3, paint1);
        canvas.drawLine(x2, y2, x4, y4, paint1);
