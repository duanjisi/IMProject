 ...
 */
public class AroundChildrenRequest extends BaseDataModel<BaseChildren> {

    public AroundChildrenRequest(String tag, Object... params) {
        super(tag, params);
    }
    ...
    protected String getApiPath() {
        return HttpUrl.FIND_AROUND_CHILDREN;
    }
}
