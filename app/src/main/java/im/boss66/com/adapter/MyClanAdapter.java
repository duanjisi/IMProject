 ...
 */
public class MyClanAdapter extends BaseRecycleViewAdapter{
    private Context context;

    public MyClanAdapter(Context context) {
    ...
    public void onBindItemHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        MyInfo.ResultBean.ClanListBean item = (MyInfo.ResultBean.ClanListBean) datas.get(position);
