...
public class ClanCofclistAdapter extends BaseRecycleViewAdapter {
    private Context context;

    public ClanCofclistAdapter(Context context) {
    ...
    public void onBindItemHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        ClanCofcListEntity.ResultBean item = (ClanCofcListEntity.ResultBean) datas.get(position);
        holder1.tv_school_name.setText(item.getName());
        holder1.tv_school_info.setText(item.getDesc());
