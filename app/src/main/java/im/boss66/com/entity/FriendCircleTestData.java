...
//    }
    ...
    public static List<FriendCircleItem> createCommentItemList() {
        List<FriendCircleItem> items = new ArrayList<FriendCircleItem>();
    ...
    public static FriendCircleItem createComment() {
