...
public class ViewpagerIndicatorOver3 extends LinearLayout {
    /**
     * 画笔
     */
    ...
    private int COLOR_INDICATOR_LINE = 0xFFe7d09a;

    public ViewpagerIndicatorOver3(Context context) {
        this(context, null);
    }

    public ViewpagerIndicatorOver3(Context context, AttributeSet attrs) {
        super(context, attrs);
        //可见tab数量
    ...
    public ViewpagerIndicatorOver3(Context context, AttributeSet attrs, int defStyleAttr) {
