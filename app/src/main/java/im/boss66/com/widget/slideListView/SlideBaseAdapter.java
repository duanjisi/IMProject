...
public abstract class SlideBaseAdapter extends BaseAdapter {
    ...
    protected View createConvertView(int position) {
        SlideItemWrapLayout item = new SlideItemWrapLayout(mContext, mSlideLeftActon,
                mSlideRightActon, getFrontViewId(position), getLeftBackViewId(position), getRightBackViewId(position));
        //new SlideItemWrapLayout(mContext, mSlideLeftActon, mSlideRightActon, getFrontViewId(position),
