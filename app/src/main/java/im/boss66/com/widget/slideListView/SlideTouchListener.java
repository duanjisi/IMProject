package im.boss66.com.widget.slideListView;
...
public class SlideTouchListener implements OnTouchListener {
    ...
    private class SlideItem {
        ...
        public SlideItem(int pos) {
            ...
            SlideListView.SlideMode slideMode = mSlideListView.getSlideAdapter().getSlideModeInPosition(position - mSlideListView.getHeaderViewsCount());
            if (rightBackView != null && (slideMode == SlideListView.SlideMode.RIGHT || slideMode == SlideListView.SlideMode.BOTH)) {
                minOffset = -rightBackView.getWidth();
            } else {
                minOffset = 0;
            }
            if (leftBackView != null && (slideMode == SlideListView.SlideMode.LEFT || slideMode == SlideListView.SlideMode.BOTH)) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_UP: {
				 ...
				 */
                    ...
                    SlideListView.SlideMode slideMode = mSlideListView.getSlideAdapter().getSlideModeInPosition(
                    ...
                    if (mSlideItem.offset > 0) {// left back view is showing
                        if (slideMode == SlideListView.SlideMode.LEFT || slideMode == SlideListView.SlideMode.BOTH) {// SlideMode
                            // support
                            // left
                        ...
                        if (slideMode == SlideListView.SlideMode.RIGHT || slideMode == SlideListView.SlideMode.BOTH) {// SlideMode
                            // support
                            // right
    ...
    private void autoScroll(final int offset, final boolean toOpen) {
        ...
        if (offset < 0) {// right back view is showing
            ...
            // front view
            SlideListView.SlideAction rightAction = mSlideListView.getSlideRightAction();
            if (mSlideItem.rightBackView != null && rightAction == SlideListView.SlideAction.SCROLL) {
            ...
            // view
            SlideListView.SlideAction leftAction = mSlideListView.getSlideLeftAction();
            if (mSlideItem.leftBackView != null && leftAction == SlideListView.SlideAction.SCROLL) {
    ...
    private void move(int offset) {
        ...
        if (offset < 0) {// offset less than 0,right back view is showing and
            ...
            if (mSlideItem.rightBackView != null) {
                ...
                SlideListView.SlideAction rightAction = mSlideListView.getSlideRightAction();
                if (rightAction == SlideListView.SlideAction.SCROLL) {
            ...
            if (mSlideItem.leftBackView != null) {
                ...
                SlideListView.SlideAction leftAction = mSlideListView.getSlideLeftAction();
                if (leftAction == SlideListView.SlideAction.SCROLL) {
