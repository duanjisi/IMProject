...
import im.boss66.com.adapter.EaseUserAdapter;
...
public class SelectMultiDialog extends BaseDialog implements View.OnClickListener {
    private static final String TAG = SelectMultiDialog.class.getSimpleName();
    private TextView cancle, ok;
    private TextView tvMsg;
    private EditText etMsg;
    private GridView gridView;
    private EaseUserAdapter adapter;
    ...
    protected int getView() {
        return R.layout.dialog_select_multi;
    }
    ...
    public void showDialog(ArrayList<EaseUser> users, MessageItem item) {
        bindData(users, item);
    ...
    private void bindData(ArrayList<EaseUser> datas, MessageItem item) {
        this.item = item;
        this.users = datas;
        setUpViews(item);
        if (users != null && users.size() != 0) {
