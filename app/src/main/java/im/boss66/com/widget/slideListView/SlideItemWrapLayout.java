...
public class SlideItemWrapLayout extends RelativeLayout {
	 ...
	 */
	public SlideItemWrapLayout(Context context, SlideListView.SlideAction slideLeftAction, SlideListView.SlideAction slideRightAction, int frontViewId, int leftBackViewId,
							   int rightBackViewId) {
		super(context);
	...
	protected void onLayout(boolean changed, int l, int t, int r, int b) {
		...
		if (mLeftBackView != null) {
			...
			if (mSlideLeftAction == SlideListView.SlideAction.SCROLL) {
		...
		if (mRightBackView != null) {
			...
			if (mSlideRightAction == SlideListView.SlideAction.SCROLL) {
